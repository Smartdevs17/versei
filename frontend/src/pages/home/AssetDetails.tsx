...
const AssetDetails: React.FC = () => {
    ...
    // Price chart data from fetched price data
    const priceData = {
    ...
    // Parse the asset price (remove " USDT" and convert to number)
            ...
            <div className="px-[150px] min-h-screen bg-gray-50 text-[#202224] p-6">
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        className="bg-transparent border border-blue-500 text-blue-500 px-4 py-2 rounded-lg hover:bg-blue-500 hover:text-white transition"
                    >
                        ADD TO WISHLIST
                    </button>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 bg-white text-black rounded-lg p-6">
                        <div className="flex space-x-4 mb-4">
                            ...
                            <button
                                className={`px-4 py-2 rounded ${activeTab === 'Holders'
                                        ? 'bg-blue-500 text-white'
                                        : 'bg-gray-200 text-gray-700'
                                    }`}
                    ...
                    <div className="bg-white text-black rounded-lg p-6">
                        <div className="flex space-x-2 mb-4">
                            <button
                                className={`px-4 py-2 rounded ${buySellTab === 'Buy' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'
                                    }`}
                            ...
                            <button
                                className={`px-4 py-2 rounded ${buySellTab === 'Sell' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'
                                    }`}
